...
teachDir = os.getcwd() + '\\TeachModels\\'
modelsDir = os.getcwd() + '\\WorkModels\\'
# 1. Завантаження даних
data = pd.read_csv(teachDir + 'diabetes_prediction_dataset.csv')
...
dump(model, modelsDir + 'diabetes_logisticRegression_model.joblib')
